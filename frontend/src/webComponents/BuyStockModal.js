  ...
  render(){
    return(
      ...
      <Modal.Body>
          ...
          {(this.state.currentQuantity*this.props.currPrice)>this.props.wallet ? <p className='text-danger'>Not enough money in wallet!</p> : null}
      ...
      <Modal.Footer>
            <Row>
                ...
                <Col>
                {(this.state.currentQuantity*this.props.currPrice)>this.props.wallet && this.state.currentQuantity>0 ?
